    ...
    if (tipo === 'bienvenida') {
      ...
      html = `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0a0a0a;color:#f2ede4;padding:2rem;border-radius:8px">
          <div style="text-align:center;margin-bottom:2rem">
            <h1 style="font-size:2rem;margin:0">busc<span style="color:#d4f53c">ARTE</span></h1>
            <p style="color:#888;font-size:.85rem">La red de músicos argentinos</p>
          </div>
          <h2 style="color:#d4f53c">¡Hola ${datos.nombre}! 🎸</h2>
          <p>Tu perfil en buscARTE está listo. Ya podés:</p>
          <ul style="line-height:2">
            <li>🔍 Buscar músicos por instrumento, género y zona</li>
            <li>📋 Publicar anuncios de búsqueda o venta</li>
            <li>💬 Contactar directamente a otros músicos</li>
            <li>🎵 Organizar jams y zapadas</li>
          </ul>
          <div style="text-align:center;margin:2rem 0">
            <a href="https://buscarte.com.ar/buscARTE_busqueda.html" 
               style="background:#d4f53c;color:#000;padding:1rem 2rem;text-decoration:none;font-weight:bold;border-radius:4px;display:inline-block">
              Explorar músicos →
            </a>
          </div>
          <p style="color:#888;font-size:.8rem;text-align:center">
            buscARTE.com.ar — La escena musical argentina
          </p>
        </div>`
      ...
      html = `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0a0a0a;color:#f2ede4;padding:2rem;border-radius:8px">
          ...
          <p style="color:#888;font-size:.8rem;text-align:center">
            buscARTE.com.ar — Si no querés recibir notificaciones, configuralo en tu perfil.
          </p>
        </div>`
      ...
      html = `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0a0a0a;color:#f2ede4;padding:2rem;border-radius:8px">
          ...
          <div style="text-align:center;margin:2rem 0">
            <a href="https://buscarte.com.ar/buscARTE_reset.html?token=${datos.token}" 
               style="background:#d4f53c;color:#000;padding:1rem 2rem;text-decoration:none;font-weight:bold;border-radius:4px;display:inline-block">
              Resetear contraseña →
            </a>
          </div>
